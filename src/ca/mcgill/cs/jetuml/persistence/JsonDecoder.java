...
public final class JsonDecoder
{
	...
	/**
	 * @param pDiagram
	 *            A JSON object that encodes the diagram.
	 * @return The decoded diagram.
	 * @throws DeserializationException
	 *             If it's not possible to decode the object into a valid diagram.
	 * @dscribe Throws ca.mcgill.cs.jetuml.persistence.DeserializationException.class when EmptyJSON
	 */
	...
	/*
	 * Extracts information about nodes from pObject and creates new objects to represent them. throws Deserialization
	 * Exception
	 */
	...
	/*
	 * Restores the parent-child hierarchy within the context's diagram. Assumes the context has been initialized with
	 * all the nodes.
	 */
