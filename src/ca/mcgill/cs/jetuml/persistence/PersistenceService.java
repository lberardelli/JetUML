...
/**
 * Services for saving and loading Diagram objects. The files are encoded in UTF-8.
 */
public final class PersistenceService
{
	 ...
	 *            The diagram to save
	 * @param pFile
	 *            The file in which to save the diagram
	 * @throws IOException
	 *             If there is a problem writing to pFile.
	 * @pre pDiagram != null.
	 * @pre pFile != null.
	 */
	 ...
	 *
	 * @param pFile
	 *            The file to read the diagram from.
	 * @return The diagram that is read in
	 * @throws IOException
	 *             if the diagram cannot be read.
	 * @throws DeserializationException
	 *             if there is a problem decoding the file.
	 * @pre pFile != null
	 * @dscribe Throws java.io.IOException.class when FileNotRead
	 */
