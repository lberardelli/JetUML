...
public enum DiagramType {
    ...
    CLASS("ClassDiagram", ".class", ClassDiagramBuilder::new, new DiagramViewer(), new DiagramElement[] { Prototypes.CLASS, Prototypes.INTERFACE, Prototypes.PACKAGE, Prototypes.PACKAGE_DESCRIPTION, Prototypes.NOTE, Prototypes.DEPENDENCY, Prototypes.GENERALIZATION, Prototypes.REALIZATION, Prototypes.ASSOCIATION, Prototypes.AGGREGATION, Prototypes.COMPOSITION, Prototypes.NOTE_CONNECTOR }), SEQUENCE("SequenceDiagram", ".sequence", SequenceDiagramBuilder::new, new SequenceDiagramViewer(), new DiagramElement[] { Prototypes.IMPLICIT_PARAMETER, Prototypes.NOTE, Prototypes.METHOD_CALL, Prototypes.METHOD_RETURN, Prototypes.NOTE_CONNECTOR }), STATE("StateDiagram", ".state", StateDiagramBuilder::new, new DiagramViewer(), new DiagramElement[] { Prototypes.STATE, Prototypes.START_STATE, Prototypes.END_STATE, Prototypes.NOTE, Prototypes.TRANSITION, Prototypes.NOTE_CONNECTOR }), OBJECT("ObjectDiagram", ".object", ObjectDiagramBuilder::new, new DiagramViewer(), new DiagramElement[] { Prototypes.OBJECT, Prototypes.FIELD, Prototypes.NOTE, Prototypes.REFERENCE, Prototypes.COLLABORATION, Prototypes.NOTE_CONNECTOR }), USECASE("UseCaseDiagram", ".usecase", UseCaseDiagramBuilder::new, new DiagramViewer(), new DiagramElement[] { Prototypes.ACTOR, Prototypes.USE_CASE, Prototypes.NOTE, Prototypes.USE_CASE_ASSOCIATION, Prototypes.USE_CASE_EXTENDS, Prototypes.USE_CASE_INCLUDES, Prototypes.USE_CASE_GENERALIZATION, Prototypes.NOTE_CONNECTOR });
    ...
    DiagramType(String pName, String pFileExtension, Function<Diagram, DiagramBuilder> pBuilderSupplier, DiagramViewer pViewer, DiagramElement[] pPrototypes) {
        assert pName != null;
        aName = pName;
