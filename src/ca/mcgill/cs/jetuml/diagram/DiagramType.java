...
/**
 * The different types of UML diagrams supported by this application.
 */
public enum DiagramType
{

	CLASS("ClassDiagram", ".class", ClassDiagramBuilder::new, new DiagramViewer(), new DiagramElement[] {
			Prototypes.CLASS, Prototypes.INTERFACE, Prototypes.PACKAGE, Prototypes.PACKAGE_DESCRIPTION, Prototypes.NOTE,
			Prototypes.DEPENDENCY, Prototypes.GENERALIZATION, Prototypes.REALIZATION, Prototypes.ASSOCIATION,
			Prototypes.AGGREGATION, Prototypes.COMPOSITION, Prototypes.NOTE_CONNECTOR }), SEQUENCE("SequenceDiagram",
					".sequence", SequenceDiagramBuilder::new, new SequenceDiagramViewer(),
					new DiagramElement[] { Prototypes.IMPLICIT_PARAMETER, Prototypes.NOTE, Prototypes.METHOD_CALL,
							Prototypes.METHOD_RETURN, Prototypes.NOTE_CONNECTOR }), STATE("StateDiagram", ".state",
									StateDiagramBuilder::new, new DiagramViewer(),
									new DiagramElement[] { Prototypes.STATE, Prototypes.START_STATE,
											Prototypes.END_STATE, Prototypes.NOTE, Prototypes.TRANSITION,
											Prototypes.NOTE_CONNECTOR }), OBJECT("ObjectDiagram", ".object",
													ObjectDiagramBuilder::new, new DiagramViewer(),
													new DiagramElement[] { Prototypes.OBJECT, Prototypes.FIELD,
															Prototypes.NOTE, Prototypes.REFERENCE,
															Prototypes.COLLABORATION,
															Prototypes.NOTE_CONNECTOR }), USECASE("UseCaseDiagram",
																	".usecase", UseCaseDiagramBuilder::new,
																	new DiagramViewer(),
																	new DiagramElement[] { Prototypes.ACTOR,
																			Prototypes.USE_CASE, Prototypes.NOTE,
	...
	/*
	 * aName is an internal name used for referring to objects of a certain diagram type in externalized
	 * representations, such as persisted versions of the diagram or property strings. It should this not be
	 * externalized.
	 */
	private final String aName;

	// The suffix that indicates the type of files
	...
	/**
	 * @param pName
	 *            The name of the diagram type, to match the getName() field. Can be null.
	 * @return The DiagramType with name pName.
	 * @throws IllegalArgumentException
	 *             if pName is not a valid diagram type name.
	 */
	@AssertThrows(exType = java.lang.IllegalArgumentException.class, factory = "DiagramType", state = "isNotDiagramTypeName", params = "foo")
	...
	/**
	 * Gets the diagram elements that can be created using the Prototype pattern. The list returned is a copy of the
	 * prototypes: it can be safely modified.
	 *
	...
	/**
	 * @param pDiagram
	 *            The diagram for which we want to build a builder.
	...
	{
		/*
		 * This method is not defined on class Diagram to avoid introducing a dependency between Diagram and the GUI
		 * framework.
		 */
	...
	/**
	 * @param pDiagram
	 *            The diagram for which we want a viewer.
