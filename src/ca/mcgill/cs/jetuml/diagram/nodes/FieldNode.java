...
public final class FieldNode extends NamedNode {
    ...
    // The object defining this field
    private Optional<ObjectNode> aObject = Optional.empty();
    ...
    /**
     * @dscribe Returns True when HasDefiningObject.
     * @dscribe Returns False when NoObject.
     */
    @Override
