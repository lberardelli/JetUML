...
/**
 * This class describes an immutable direction in the 2D plane. The direction is conceptually represented as an angle in
 * degrees between 0 and 359 inclusively, where 0 represents "up" or "north", and where an increase in the angle moves
 * the direction clockwise. A direction can be expressed with a precision of a maximum of one degree.
 */
@Immutable
@Flyweight
public final class Direction
{
	...
	/**
	 * @return true if and only if this direction represents one of the four cardinal directions, namely NORTH, SOUTH,
	 *         EAST, WEST.
	 */
	 ...
	 * @pre pAngle in [0,359]
	 * @dscribe Returns a Direction object
	 */
	...
	/**
	 * Returns the direction equivalent to the direction represented by the line between pStart and pEnd.
	 *
	 * @param pStart
	 *            The starting point
	 * @param pEnd
	 ...
	 *
	 * @param pAngle
	 *            The angle in degrees for which to turn the direction.
	...
	/**
	 * @param pStart
	 *            The start angle (inclusive)
	 * @param pEnd
	 *            The end angle (exclusive)
	...
	/*
	 * Computes an angle given a width an a height, so that angle 0 corresponds to pWidth=0 and pHeight > 0, in other
	 * words a vector pointing north.
	 */
