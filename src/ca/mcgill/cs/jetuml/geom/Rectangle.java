...
public class Rectangle {
    ...
    public boolean contains(Point pPoint) {
        assert pPoint != null;
        return pPoint.getX() >= aX && pPoint.getX() <= aX + aWidth && pPoint.getY() >= aY && pPoint.getY() <= aY + aHeight;
    }
    ...
    public boolean contains(Rectangle pRectangle) {
        ...
        return pRectangle.aX >= aX && pRectangle.aY >= aY && pRectangle.getMaxX() <= aX + aWidth && pRectangle.getMaxY() <= aY + aHeight;
    }
