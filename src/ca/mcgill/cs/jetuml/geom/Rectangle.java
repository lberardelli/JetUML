...
/**
 * A framework independent representation of a rectangle in 2-dimensional integer space.
 */
@Immutable
public class Rectangle
{
	...
	/**
	 * @param pDeltaX
	 *            The amount to translate in the X-coordinate.
	 * @param pDeltaY
	 *            The amount to translate in the Y-coordinate.
	...
	{
		assert pPoint != null;
		return pPoint.getX() >= aX && pPoint.getX() <= aX + aWidth && pPoint.getY() >= aY
				&& pPoint.getY() <= aY + aHeight;
	}
	...
	public boolean contains(Rectangle pRectangle)
	{
		...
		return pRectangle.aX >= aX && pRectangle.aY >= aY && pRectangle.getMaxX() <= aX + aWidth
