...
import ca.mcgill.cs.jetuml.annotations.DScribeAnnotations.AsFactory;
...
public class Line
{
	 ...
	 *
	 * @param pPoint1
	 *            The first point in the line. Conceptually the "start" of the line.
	 * @param pPoint2
	 *            The second point in the line. Conceptually the "end" of the line.
	 * @pre pPoint1 != null
	 * @pre pPoint2 != null
	 */
	...
	{
		return new Rectangle(min(getX1(), getX2()), min(getY1(), getY2()), abs(getX2() - getX1()),
				abs(getY2() - getY1()));
	}
