...
public final class Version implements Comparable<Version> {
    ...
    private static final Comparator<Version> COMPARATOR = Comparator.<Version, Integer>comparing(version -> version.aMajor).<Integer>thenComparing(version -> version.aMinor).<Integer>thenComparing(version -> version.aPatch);
    ...
    /**
     * @dscribe Encodes Version data as string
     */
    @Override
    ...
    /**
     * Determines if this version of the diagram is fully compatible with pLaterVersion of the application.
     *
     * @param pLaterVersion
     *            The version to load a diagram in.
