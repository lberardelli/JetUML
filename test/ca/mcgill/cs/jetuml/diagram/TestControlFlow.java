...
public class TestControlFlow {
    ...
    @Test
    @AssertBool(bool = "False", factory = "new ControlFlow(new Diagram(DiagramType.SEQUENCE))", state = "ParamIsNotCallNode", params = { "new ObjectNode()" }, uut = "isConstructorExecution(Node)")
    public void isConstructorExecution_WhenParamIsNotCallNode_ReturnFalse() {
        boolean actual = new ControlFlow(new Diagram(DiagramType.SEQUENCE)).isConstructorExecution(new ObjectNode());
        assertFalse(actual);
    }
}
