...
public class TestJsonDecoder
{
	...
	@Test
	@AssertThrows(exType = ca.mcgill.cs.jetuml.persistence.DeserializationException.class, factory = "JsonDecoder", state = "EmptyJSON", params = "new JSONObject()", uut = "decode(JSONObject)")
	public void decode_WhenEmptyJSON_ThrowDeserializationException()
	{
		assertThrows(ca.mcgill.cs.jetuml.persistence.DeserializationException.class,
				() -> JsonDecoder.decode(new JSONObject()));
	}
}
